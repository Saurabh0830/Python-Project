...
vTcl:font:add_font \
    "-family {Segoe UI} -size 12 -weight bold -slant italic -underline 0 -overstrike 0" \
    user \
    vTcl:font10
vTcl:font:add_font \
...
proc vTclWindow.top37 {base} {
    ...
    vTcl:DefineAlias "$site_3_0.ent42" "dispatcherusername" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent43 \
        -background white -disabledforeground {#a3a3a3} -font TkFixedFont \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -insertbackground black \
        -selectbackground {#c4c4c4} -selectforeground black -show * 
    vTcl:DefineAlias "$site_3_0.ent43" "dispatcherpassword" vTcl:WidgetProc "Toplevel1" 1
    button $site_3_0.but44 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -borderwidth 0 -command validateDispatcherLogin \
    ...
    place $site_3_0.lab40 \
        -in $site_3_0 -x 50 -y 110 -width 152 -relwidth 0 -height 36 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab41 \
        -in $site_3_0 -x 40 -y 160 -width 152 -height 36 -anchor nw \
        -bordermode inside 
    place $site_3_0.ent42 \
        -in $site_3_0 -x 200 -y 110 -width 264 -relwidth 0 -height 34 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent43 \
        -in $site_3_0 -x 190 -y 160 -width 264 -height 34 -anchor nw \
        -bordermode inside 
    place $site_3_0.but44 \
        -in $site_3_0 -x 220 -y 230 -width 136 -relwidth 0 -height 43 \
        -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
