...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 474x233+699+276
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    wm deiconify $top
    wm title $top "DChangePassword"
    vTcl:DefineAlias "$top" "Toplevel1" vTcl:Toplevel:WidgetProc "" 1
    frame $top.fra38 \
        -borderwidth 10 -relief groove -background {#c4632b} -height 215 \
        -width 455 
    ...
    vTcl:DefineAlias "$site_3_0.ent42" "DOldPassword" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent43 \
        -background white -disabledforeground {#a3a3a3} -font TkFixedFont \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -insertbackground black \
        -selectbackground {#c4c4c4} -selectforeground black 
    vTcl:DefineAlias "$site_3_0.ent43" "DNewPassword" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent44 \
        -background white -disabledforeground {#a3a3a3} -font TkFixedFont \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -insertbackground black \
        -selectbackground {#c4c4c4} -selectforeground black 
    vTcl:DefineAlias "$site_3_0.ent44" "DConfirmPassword" vTcl:WidgetProc "Toplevel1" 1
    button $site_3_0.but45 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command DispatcherHome_CBack \
    ...
    button $site_3_0.but46 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command DispatcherHome_CSave \
        -disabledforeground {#a3a3a3} -font $::vTcl(fonts,vTcl:font10,object) \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -pady 0 -text Save 
    vTcl:DefineAlias "$site_3_0.but46" "Button1_5" vTcl:WidgetProc "Toplevel1" 1
    place $site_3_0.lab39 \
        -in $site_3_0 -x 20 -y 30 -width 152 -relwidth 0 -height 26 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab40 \
        -in $site_3_0 -x 10 -y 60 -width 152 -height 26 -anchor nw \
        -bordermode inside 
    place $site_3_0.lab41 \
        -in $site_3_0 -x 0 -y 100 -width 192 -relwidth 0 -height 26 \
        -relheight 0 -anchor nw -bordermode inside 
    place $site_3_0.ent42 \
        -in $site_3_0 -x 170 -y 30 -width 184 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent43 \
        -in $site_3_0 -x 170 -y 60 -width 184 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode inside 
    place $site_3_0.ent44 \
        -in $site_3_0 -x 190 -y 100 -width 184 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode inside 
    place $site_3_0.but45 \
        -in $site_3_0 -x 110 -y 160 -width 76 -relwidth 0 -height 33 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but46 \
        -in $site_3_0 -x 250 -y 150 -width 76 -height 33 -anchor nw \
        -bordermode inside 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra38 \
        -in $top -x 10 -y 10 -width 455 -relwidth 0 -height 215 -relheight 0 \
