...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 625x764+646+137
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    wm deiconify $top
    wm title $top "Customer_View"
    vTcl:DefineAlias "$top" "Toplevel1" vTcl:Toplevel:WidgetProc "" 1
    frame $top.fra38 \
        -borderwidth 10 -relief groove -background {#c4632b} -height 685 \
        -highlightbackground {#d9d9d9} -highlightcolor black -width 605 
    vTcl:DefineAlias "$top.fra38" "CustomerView" vTcl:WidgetProc "Toplevel1" 1
    frame $top.fra39 \
    ...
    label $site_3_0.lab41 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black -text {Sr. No} 
    ...
    vTcl:DefineAlias "$site_3_0.lab42" "Label1_1" vTcl:WidgetProc "Toplevel1" 1
    label $site_3_0.lab43 \
        ...
        -text {Contact No} 
    vTcl:DefineAlias "$site_3_0.lab43" "Label1_2" vTcl:WidgetProc "Toplevel1" 1
    label $site_3_0.lab44 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#c4632b} -disabledforeground {#a3a3a3} \
        -font $::vTcl(fonts,vTcl:font9,object) -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text Name 
    vTcl:DefineAlias "$site_3_0.lab44" "Label1_3" vTcl:WidgetProc "Toplevel1" 1
    place $site_3_0.lab41 \
        -in $site_3_0 -x 30 -y 30 -width 72 -relwidth 0 -height 26 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab42 \
        -in $site_3_0 -x 150 -y 20 -width 102 -relwidth 0 -height 26 \
        -relheight 0 -anchor nw -bordermode inside 
    place $site_3_0.lab43 \
        -in $site_3_0 -x 300 -y 20 -width 122 -relwidth 0 -height 26 \
        -relheight 0 -anchor nw -bordermode inside 
    place $site_3_0.lab44 \
        -in $site_3_0 -x 450 -y 20 -width 102 -relwidth 0 -height 26 \
        -relheight 0 -anchor nw -bordermode inside 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra38 \
        -in $top -x 10 -y 70 -width 605 -relwidth 0 -height 685 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.fra39 \
        -in $top -x 10 -y 10 -width 605 -relwidth 0 -height 75 -relheight 0 \
        -anchor nw -bordermode ignore 
