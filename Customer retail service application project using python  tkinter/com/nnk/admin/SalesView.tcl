...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 812x791+650+150
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    wm deiconify $top
    wm title $top "Sales_View"
    vTcl:DefineAlias "$top" "Toplevel1" vTcl:Toplevel:WidgetProc "" 1
    frame $top.fra38 \
        -borderwidth 10 -relief groove -background {#c4632b} -height 715 \
        -highlightbackground {#d9d9d9} -highlightcolor black -width 785 
    vTcl:DefineAlias "$top.fra38" "View" vTcl:WidgetProc "Toplevel1" 1
    frame $top.fra39 \
    ...
    place $site_3_0.lab40 \
        -in $site_3_0 -x 20 -y 30 -width 92 -relwidth 0 -height 26 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab41 \
        -in $site_3_0 -x 160 -y 20 -width 92 -height 26 -anchor nw \
        -bordermode inside 
    place $site_3_0.lab42 \
        -in $site_3_0 -x 320 -y 20 -width 92 -height 26 -anchor nw \
        -bordermode inside 
    place $site_3_0.lab43 \
        -in $site_3_0 -x 480 -y 20 -width 92 -height 26 -anchor nw \
        -bordermode inside 
    place $site_3_0.lab44 \
        -in $site_3_0 -x 650 -y 20 -width 92 -height 26 -anchor nw \
        -bordermode inside 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra38 \
        -in $top -x 10 -y 70 -width 785 -relwidth 0 -height 715 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.fra39 \
        -in $top -x 10 -y 0 -width 785 -relwidth 0 -height 75 -relheight 0 \
        -anchor nw -bordermode ignore 
