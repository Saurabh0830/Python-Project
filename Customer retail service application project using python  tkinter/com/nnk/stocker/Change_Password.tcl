...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 555x355+650+236
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    wm deiconify $top
    wm title $top "Change_Password"
    vTcl:DefineAlias "$top" "Toplevel1" vTcl:Toplevel:WidgetProc "" 1
    frame $top.fra38 \
        -borderwidth 10 -relief groove -background {#c4632b} -height 335 \
        -width 535 
    ...
    vTcl:DefineAlias "$site_3_0.ent43" "OldPassword" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent44 \
        -background white -disabledforeground {#a3a3a3} -font TkFixedFont \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -insertbackground black \
        -selectbackground {#c4c4c4} -selectforeground black 
    vTcl:DefineAlias "$site_3_0.ent44" "NewPassword" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent45 \
        -background white -disabledforeground {#a3a3a3} -font TkFixedFont \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -insertbackground black \
        -selectbackground {#c4c4c4} -selectforeground black 
    vTcl:DefineAlias "$site_3_0.ent45" "ConfirmPassword" vTcl:WidgetProc "Toplevel1" 1
    button $site_3_0.but46 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command ChangePassword \
    ...
    place $site_3_0.lab39 \
        -in $site_3_0 -x 120 -y 30 -width 312 -relwidth 0 -height 46 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab40 \
        -in $site_3_0 -x 50 -y 110 -width 182 -relwidth 0 -height 36 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab41 \
        -in $site_3_0 -x 30 -y 150 -width 182 -height 36 -anchor nw \
        -bordermode inside 
    place $site_3_0.lab42 \
        -in $site_3_0 -x 0 -y 200 -width 202 -relwidth 0 -height 36 \
        -relheight 0 -anchor nw -bordermode inside 
    place $site_3_0.ent43 \
        -in $site_3_0 -x 230 -y 110 -width 254 -relwidth 0 -height 34 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.ent44 \
        -in $site_3_0 -x 220 -y 150 -width 254 -height 34 -anchor nw \
        -bordermode inside 
    place $site_3_0.ent45 \
        -in $site_3_0 -x 220 -y 200 -width 254 -height 34 -anchor nw \
        -bordermode inside 
    place $site_3_0.but46 \
        -in $site_3_0 -x 230 -y 260 -width 96 -relwidth 0 -height 33 \
        -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra38 \
        -in $top -x 10 -y 10 -width 535 -relwidth 0 -height 335 -relheight 0 \
