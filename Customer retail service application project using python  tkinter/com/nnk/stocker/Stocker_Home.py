...
def vp_start_gui():
    ...
    Stocker_Home_support.init(root, top)
    root.mainloop()
...
def create_Stocker_Home(root, *args, **kwargs):
    ...
    w = Toplevel (root)
    top = Stocker_Home (w)
    Stocker_Home_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Stocker_Home:
    def __init__(self, top=None):
        ...
        top.geometry("483x555+647+211")
        top.title("Stocker_Home")
        ...
        self.Label1.place(relx=0.14, rely=0.09, height=46, width=332)
        ...
        self.Label1.configure(text='''Stocker Home''')

        self.Button1 = Button(self.Frame1)
        self.Button1.place(relx=0.23, rely=0.23, height=43, width=246)
        self.Button1.configure(activebackground="#d9d9d9")
        self.Button1.configure(activeforeground="#000000")
        self.Button1.configure(background="#d9d9d9")
        self.Button1.configure(command=Stocker_Home_support.StockerHome_ChangePassword)
        ...
        self.Button1_1.place(relx=0.23, rely=0.38, height=43, width=246)
        self.Button1_1.configure(activebackground="#d9d9d9")
        self.Button1_1.configure(activeforeground="#000000")
        self.Button1_1.configure(background="#d9d9d9")
        self.Button1_1.configure(command=Stocker_Home_support.StockerHome_AddProduct)
        ...
        self.Button1_2.place(relx=0.23, rely=0.52, height=43, width=246)
        ...
        self.Button1_2.configure(command=Stocker_Home_support.StockerHome_ViewProduct)
        ...
        self.Button1_3.place(relx=0.33, rely=0.79, height=43, width=166)
        ...
        self.Button1_3.configure(command=Stocker_Home_support.StockerHome_Logout)
        ...
        self.Button1_1 = Button(self.Frame1)
        self.Button1_1.place(relx=0.23, rely=0.67, height=43, width=246)
        self.Button1_1.configure(activebackground="#d9d9d9")
        self.Button1_1.configure(activeforeground="#000000")
        self.Button1_1.configure(background="#d9d9d9")
        self.Button1_1.configure(command=Stocker_Home_support.StockerHome_DeleteProduct)
        self.Button1_1.configure(disabledforeground="#a3a3a3")
        self.Button1_1.configure(font=font9)
        self.Button1_1.configure(foreground="#000000")
        self.Button1_1.configure(highlightbackground="#d9d9d9")
        self.Button1_1.configure(highlightcolor="black")
        self.Button1_1.configure(pady="0")
        self.Button1_1.configure(text='''Delete Product''')
