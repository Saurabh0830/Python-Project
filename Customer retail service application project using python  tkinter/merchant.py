...
from main import merchant_support
...
def vp_start_gui():
    ...
    root = Tk()
    top = Home (root)
    merchant_support.init(root, top)
    root.mainloop()
...
def create_Home(root, *args, **kwargs):
    ...
    w = Toplevel (root)
    top = Home (w)
    merchant_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Home:
    def __init__(self, top=None):
        ...
        self.Frame1.place(relx=0.07, rely=0.04, relheight=0.9, relwidth=0.86)
        ...
        self.Button1.place(relx=0.22, rely=0.12, height=53, width=266)
        self.Button1.configure(activebackground="#d9d9d9")
        self.Button1.configure(activeforeground="#000000")
        self.Button1.configure(background="#d9d9d9")
        self.Button1.configure(command=merchant_support.open_AdminLogin)
        ...
        self.Button1_1.place(relx=0.22, rely=0.34, height=53, width=266)
        self.Button1_1.configure(activebackground="#d9d9d9")
        self.Button1_1.configure(activeforeground="#000000")
        self.Button1_1.configure(background="#d9d9d9")
        self.Button1_1.configure(command=merchant_support.open_StockerLogin)
        ...
        self.Button1_2.place(relx=0.22, rely=0.55, height=53, width=266)
        ...
        self.Button1_2.configure(command=merchant_support.open_DispatcherLogin)
        ...
        self.Button1_3.place(relx=0.22, rely=0.77, height=53, width=266)
        ...
        self.Button1_3.configure(command=merchant_support.open_AboutUs)
        ...
        self.Button1_3.configure(text='''About us''')
